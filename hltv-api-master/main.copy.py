...
def get_player_rating():
    div = get_parsed_page("http://www.hltv.org/?pageid=173&playerid="  + str(player_id))
    rating = div.find("div", {"class": "covSmallHeadline", "style": "font-weight:normal;width:100px;float:left;text-align:right;color:black;font-weight:bold"}).text
    return rating
...
if __name__ == "__main__":
  ...
  #  pp.pprint(_get_lineup(player_anchors))
